...
class FlowGraph(CoreFlowgraph, Drawable):
    ...
    def _get_unique_id(self, base_id=''):
        ...
        for index in count():
            print('gui/canvas/flowchart.py: base_id =', base_id, ' index =',index)
    ...
    def add_new_block(self, key, coor=None):
        ...
        """
        print('grc/gui/canvas/flowgraph.py: add_new_block: key =',key)
        ...
        # get the new block
        print('canvas/flowgraph.py: add_new_block: key:', key)
