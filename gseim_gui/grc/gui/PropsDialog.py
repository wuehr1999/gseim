...
class PropsDialog(Gtk.Dialog):
    ...
    def __init__(self, parent, block):
        ...
        if True:
            ...
            print('PropsDialog __init__: block.category:', block.category)
            print('PropsDialog __init__: block.name:', block.name)

            if block.category:
                if 'Hier' in str(block.category):
                    print('PropsDialog __init__: Hier block')
                    ...
                    print('PropsDialog __init__: non-Hier block')
