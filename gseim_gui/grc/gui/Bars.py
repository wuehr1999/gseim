...
MENU_BAR_LIST = [
  ...
  ('_Edit', [
    ...
    [Actions.BLOCK_CUT, Actions.BLOCK_COPY, Actions.BLOCK_PASTE, Actions.ELEMENT_DELETE,
     Actions.SELECT_ALL],
    [('_Gparms', Actions.GPARM_OPS)],
    [('_Outvars', Actions.OUTVAR_OPS)],
    [('_SolveBlocks', Actions.SOLVEBLOCK_OPS)],
    [('_OutputBlocks', Actions.OUTPUTBLOCK_OPS)],
...
CONTEXT_MENU_LIST = [
    [Actions.BLOCK_CUT, Actions.BLOCK_COPY, Actions.BLOCK_PASTE, Actions.ELEMENT_DELETE],
    [Actions.BLOCK_ROTATE_CCW, Actions.BLOCK_ROTATE_CW, Actions.BLOCK_ENABLE,
