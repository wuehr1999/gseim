...
#   name = 'GNU Radio Companion (no gui)'
    ...
    hier_block_lib_dir = home_dir + '/gseim_gui/subckt'
    block_lib_dir      = home_dir + '/gseim_gui/blocks'
    gseim_output_dir   = home_dir + '/gseim_gui/gseim/output'
    gseim_xbe_dir      = home_dir + '/gseim_gui/gseim/xbe'
    gseim_exec_dir     = home_dir + '/gseim_gui/gseim/exec'
    gseim_cpp_dir      = home_dir + '/gseim_gui/gseim/cppsrc'

#   hier_block_lib_dir = '~/gseim_gui/subckt'
#   block_lib_dir      = '~/gseim_gui/blocks'
#   gseim_output_dir   = '~/gseim_gui/gseim/output'
#   gseim_xbe_dir      = '~/gseim_gui/gseim/xbe'
#   gseim_exec_dir     = '~/gseim_gui/gseim/exec'
#   gseim_cpp_dir      = '~/gseim_gui/gseim/cppsrc'
