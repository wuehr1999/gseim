...
// get partial fractions:
   ...
   cout << "filter_compute_coef: degree_n: " <<  degree_n << endl;
   cout << "filter_compute_coef: degree_d: " <<  degree_d << endl;
   ...
   cout << "filter_compute_coef: partial_fractions_1 done." << endl;

   cout << "filter_compute_coef: coef info:" << endl;
   cout << gain << "  " << a0p << " --- gain, a0p" << endl;
