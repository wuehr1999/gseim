...
// indices for flags:
   int i_init_guess,i_dc,i_startup,i_trns,i_one_time_parms,i_save_history,
       i_next_time,i_update_states;
   int i_evaluate,i_reset_x,i_x_matrix;
   int i_outvar;
   int i_explicit,i_implicit,i_alg_loop;
   int i_function,i_jacobian;
   int i_limit_newton;
   int i_trns_first_x,i_trns_first_e;
