...
void x_filter_1(Global &G,XbeUsr &X,XbeJac &J) {
   double x;
   double y;
   int scale_coef;
...
void x_sum_4(Global &G,XbeUsr &X,XbeJac &J) {
   double x1,x2,x3,x4;
   double y;
   double k1,k2,k3,k4;
   const int nvr_x1 = 0;
...
void x_sum_5(Global &G,XbeUsr &X,XbeJac &J) {
   ...
   if (G.flags[G.i_outvar]) {
     ...
     X.outprm[no_x3] = X.val_vr[nvr_x3];
     X.outprm[no_x4] = X.val_vr[nvr_x4];
     X.outprm[no_x5] = X.val_vr[nvr_x5];
     X.outprm[no_y ] = X.val_vr[nvr_y ];
     return;
   }
   return;
}
void x_sum_6(Global &G,XbeUsr &X,XbeJac &J) {
   ...
   if (G.flags[G.i_outvar]) {
     ...
     X.outprm[no_x4] = X.val_vr[nvr_x4];
     X.outprm[no_x5] = X.val_vr[nvr_x5];
     X.outprm[no_x6] = X.val_vr[nvr_x6];
     X.outprm[no_y ] = X.val_vr[nvr_y ];
     return;
   }
   return;
