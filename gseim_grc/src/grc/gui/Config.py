...
#   name = 'GNU Radio Companion'
    ...
    gui_prefs_file = os.environ.get(
        'GRC_PREFS_PATH', os.path.expanduser('~/gseim_grc/gseim.conf'))
...
#       override definitions of auto_hide_port_labels etc

        self.parser['main']['snap_to_grid'] = 'True'
        self.parser['main']['auto_hide_port_labels'] = 'True'
        self.parser['main']['show_block_comments'] = 'True'
        self.parser['main']['show_generated_code_tab'] = 'True'
        self.parser['main']['hide_disabled'] = 'False'
        self.parser['main']['screen_shot_background_transparent'] = 'False'
        self.parser['main']['blocks_window_visible'] = 'True'
        self.parser['main']['console_window_visible'] = 'True'
        self.parser['main']['scroll_lock'] = 'True'
        self.parser['main']['hide_variables'] = 'False'
        self.parser['main']['variable_editor_visible'] = 'False'
        self.parser['main']['show_flowgraph_complexity'] = 'False'

    def save(self):
        try:
            with open(os.path.expanduser(self.gui_prefs_file), 'w') as fp:
                fp.write(HEADER)
